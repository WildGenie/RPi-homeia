...
class InstallRequirement(object):
    ...
    @property
    def name(self):
        return None if self.req is None else self.req.project_name

    @property
    def url_name(self):
        return None if self.req is None else urllib.quote(self.req.unsafe_name)
...
"""
    ...
    def requirements(self, extras=()):
        ...
        for line in self.egg_info_lines('requires.txt'):
            if match := self._requirements_section_re.match(line.lower()):
